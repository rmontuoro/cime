...
CONTAINS
  ...
  subroutine avfld_set(count_only)
    ...
    index = 0
    call avfld_add(avifld, avofld, index, count_only, drof_fld="rofl",  driver_fld="Forr_rofl"   )
    call avfld_add(avifld, avofld, index, count_only, drof_fld="rofi",  driver_fld="Forr_rofi"   )
  ...
  subroutine drof_comp_init( EClock, cdata, x2r, r2x, NLFilename )
    ...
    ! !DESCRIPTION: initialize data rof model
  ...
  subroutine drof_comp_run( EClock, cdata, x2r, r2x)
    ...
    ! !DESCRIPTION: run method for data rof model
  ...
  subroutine drof_comp_final()
    ...
    ! !DESCRIPTION: finalize method for data rof model
  ...
  !===============================================================================
  subroutine avfld_add(avofld, avifld, size, count_only, drof_fld, driver_fld)
    character(len=*), intent(inout) :: avofld(:)
    character(len=*), intent(inout) :: avifld(:)
    integer         , intent(inout) :: size
    logical         , intent(in)    :: count_only
    character(len=*), intent(in)    :: drof_fld
